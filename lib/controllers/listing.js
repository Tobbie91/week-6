...
const createListing = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const listing = yield ListingService.createListing(Object.assign(Object.assign({}, req.body), { image: `${env_1.default.FILE_HOST}${filepath}`, authorId: req.user.id }));
...
const updateListing = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(req.file);
        const filepath = req.file.path.split("public")[1];
        const listing = yield ListingService.updateListing(req.params.id, Object.assign(Object.assign({}, req.body), { userId: req.user.id, image: `${env_1.default.FILE_HOST}${filepath}` }));
...
const deleteListing = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const listing = yield ListingService.deleteListing(req.params.id, req.user.id);
